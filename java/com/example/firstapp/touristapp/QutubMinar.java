...
public class QutubMinar extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        if(v==btn2) {
            Toast.makeText(QutubMinar.this, "Timings: 9am – 6pm (Tuesday to Sunday)\n" +
                    "\n" +
                    "Entry Fee:\n" +
                    "\n" +
                    "INR 10 (Indians)\n" +
            ...
            Intent i=new Intent(QutubMinar.this,Choose.class);
            startActivity(i);
        }
    }
    }
